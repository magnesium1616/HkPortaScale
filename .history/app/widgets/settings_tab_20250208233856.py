...
class SettingsTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.suffix_edit = QLineEdit(self.config.get_setting("output_suffix"))
        ...
        self.dir_name_edit = QLineEdit(self.config.get_setting("output_dir"))
        ...
        self.padding_spin.setValue(self.config.get_setting("padding_digits"))
