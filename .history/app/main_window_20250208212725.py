...
class MainWindow(QMainWindow):
    ...
    def create_settings_tab(self):
        ...
        settings = {
            ...
            "rename_enabled": self.config.get_setting("rename_enabled"),
            "rename_name": self.config.get_setting("rename_name"),
            "padding_digits": self.config.get_setting("padding_digits")
        }
